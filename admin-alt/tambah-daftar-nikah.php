									...
									<div class="col-md-10">
										<form action="" method="post" class="f1">
											...
											<fieldset>
												...
												<div class="find-umur">
													<div class="form-group">
														...
														<input class="form-control umur" type="date" name="tggl_lahir_sm" id="tggl_lahir_sm">
													</div>
													<div class="form-group">
														<label>Umur</label>
												...
												<div class="form-group">
													...
													<input class="form-control" type="text" placeholder="Nama Ayah Suami" id="nama_as" name="nama_as">
												</div>
												<div class="form-group">
													<label>Nama Ibu Suami</label>
													<input class="form-control" type="text" placeholder="Nama Ibu Suami" id="nama_is" name="nama_is">
												</div>
												<div class="f1-buttons">
											...
											<fieldset>
												...
												<div class="form-group">
													<label>Tempat Lahir</label>
													<input class="form-control" type="text" placeholder="Tempat Lahir" id="tempat_lahir_is" name="tempat_lahir_is">
												</div>
												<div class="find-umur">
													<div class="form-group">
														<label>Tanggal Lahir</label>
														<input class="form-control umur" type="date" name="tggl_lahir_is" id="tggl_lahir_is">
													</div>
													<div class="form-group">
														<label>Umur</label>
												...
												<div class="form-group">
													...
													<input class="form-control" type="text" placeholder="Nama Ayah Istri" id="nama_ai" name="nama_ai">
												</div>
												<div class="form-group">
													<label>Nama Ibu Istri</label>
													<input class="form-control" type="text" placeholder="Nama Ibu Istri" id="nama_ii" name="nama_ii">
												</div>
												<div class="f1-buttons">
													<button type="button" class="btn btn-warning btn-previous"><i class="fa fa-arrow-left"></i> Sebelumnya</button>
													<button type="button" class="btn btn-primary btn-next">Selanjutnya <i class="fa fa-arrow-right"></i></button>
											...
											<fieldset>
												...
												<div class="form-group">
													<label>Agama</label>
													<input class="form-control" id="agama_wali" type="text" placeholder="Agama" name="agama_wali" readonly="" value="Islam">
												</div>
												<div class="form-group">
													<label>Hubungan Wali</label>
													<input class="form-control" type="text" placeholder="Hubungan Wali" name="hubungan_wali" id="hubungan_wali">
												</div>
												<div class="form-group">
													<label>Tempat Lahir</label>
													<input class="form-control" type="text" placeholder="Tempat Lahir" id="tempat_lahir_wl" name="tempat_lahir_wl">
												</div>
												<div class="find-umur">
													<div class="form-group">
														<label>Tanggal Lahir</label>
														<input class="form-control umur" type="date" name="tggl_lahir_wl" id="tggl_lahir_wl">
													</div>
													<div class="form-group">
														<label>Umur</label>
														<input type="text" id="umur_wali" class="text-primary form-control result" name="umur_wali" placeholder="Umur">
													</div>
												</div>
												<div class="form-group">
													<label>Alamat</label>
												...
												<div class="form-group">
													<label>Pekerjaan</label>
													<input type="text" id="pekerjaan_wali" class="form-control" name="pekerjaan_wali" placeholder="Pekerjaan">
												</div>
												<div class="form-group">
													<label>Bin</label>
											...
											<fieldset>
												...
												<div class="f1-buttons">
													<button type="button" class="btn btn-warning btn-previous"><i class="fa fa-arrow-left"></i> Sebelumnya</button>
													<button type="submit" class="btn btn-primary btn-submit" name="store_data"><i class="fa fa-save"></i> Submit</button>
												</div>
											</fieldset>
										</form>
									</div>
