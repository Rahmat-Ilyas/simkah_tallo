			...
			<form method="POST">
				...
				<div class="modal-body px-5" style="margin-bottom: -20px;">
					...
					<div class="mb-3 row">
					    ...
					    <div class="col-sm-9">
					      <input class="form-control input-lg umur" type="date" name="tggl_lahir_sm" id="tggl_lahir_sm"><br>
					    </div>
				...
				<div class="modal-body px-5" style="margin-bottom: -20px;">
					...
					<div class="mb-3 row">
					    ...
					    <div class="col-sm-9">
					      <input class="form-control input-lg" id="nik_istri" name="nik_istri" type="text" placeholder="Nik Calon Istri">
					    </div>
					</div>
					<div class="mb-3 row">
					...
					<div class="mb-3 row">
                        ...
                        <label for="" class="col-sm-3 col-form-label">Umur</label>
                        <div class="col-sm-9">
                           <input type="text" id="umur_istri" class="text-primary form-control input-lg result" placeholder="Umur" name="umur_istri" id="umur_istri">
                        </div>
					</div>
					<div class="mb-3 row">
					    <label for="" class="col-sm-3 col-form-label">Alamat</label>
				...
				<div class="modal-body px-5" style="margin-bottom: -20px;">
					...
					<div class="mb-3 row">
					    ...
					    <div class="col-sm-9">
					      <input class="form-control input-lg" id="nik_wali" name="nik_wali" type="text" placeholder="Nik Wali">
					    </div>
					</div>
					<div class="mb-3 row">
					...
					<div class="mb-3 row">
						...
						<div class="col-sm-9">
	                        <select class="form-control  input-lg validate-select required-entry" defaultvalue="" name="status_wali" id="status_wali">
					...
					<div class="mb-3 row">
					    <label for="" class="col-sm-3 col-form-label">Agama</label>
					    <div class="col-sm-9">
					      <input class="form-control input-lg" id="agama_wali" type="text" placeholder="Agama" value="Islam" readonly="" name="agama_wali">
					    </div>
					</div>
					<div class="mb-3 row">
					    <label for="" class="col-sm-3 col-form-label">Hubungan Wali</label>
					    <div class="col-sm-9">
					      <input class="form-control input-lg" type="text" placeholder="Hubungan Wali" name="nama_wali" id="hubungan_wali">
					    </div>
					</div>
					<div class="mb-3 row">
					    <label for="" class="col-sm-3 col-form-label">Tempat Lahir</label>
					...
					<div class="mb-3 row">
                        ...
                        <label for="" class="col-sm-3 col-form-label">Umur</label>
                        <div class="col-sm-9">
                           <input type="text" id="umur_wali" class="text-primary form-control input-lg result" placeholder="Umur" name="umur_wali" id="umur_wali">
                        </div>
					</div>
					<div class="mb-3 row">
					    <label for="" class="col-sm-3 col-form-label">Alamat</label>
					...
					<div class="mb-3 row">
					    <label for="" class="col-sm-3 col-form-label">Pekerjaan</label>
					    <div class="col-sm-9">
					      <input class="form-control input-lg" type="text" placeholder="Pekerjaan" id="pekerjaan_wali" name="pekerjaan_wali">
					    </div>
					</div>
					<div class="mb-3 row">
