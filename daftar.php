            ...
            <div class="navbar">
                <div class="navbar-inner">
                    <ul class="nav nav-pills nav-wizard">
                        <li class="active">
                            <a class="tab-head-this hidden-xs" href="#step1" data-toggle="tab" data-step="1">1. Pilih Kelurahan/Desa dan Jadwal Akad</a>
                            <a class="tab-head-this visible-xs" href="#step1" data-toggle="tab" data-step="1">1.</a>
                            <div class="nav-arrow"></div>
                        </li>
                        <li class="">
                            <div class="nav-wedge"></div>
                            <a class="tab-head-this hidden-xs" href="#step2" data-toggle="tab" data-step="2">2. Isi Form Pendaftaran</a>
                            <a class="tab-head-this visible-xs" href="#step2" data-toggle="tab" data-step="2">2.</a>
                            <div class="nav-arrow"></div>
                        </li>
                        <li class="">
                            <div class="nav-wedge"></div>
                            <a class="tab-head-this hidden-xs" href="#step3" data-toggle="tab" data-step="3">3. Bukti Pendaftaran</a>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control input-lg" type="date" id="date">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Waktu Akad Nikah</label>
                                    <input class="form-control input-lg" type="time" id="time">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                        ...
                                        <div class="col-xs-12 col-md-13">
                                            <div class="form-group">
                                                ...
                                                <div class="row col-xs-11 col-md-12">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="checkbox" name="" id="" class="pull-right" value="ya" onclick="">
                                                    </div>
                                                </div>
                                                <div class="row col-xs-11 col-md-12">
                                                    <div class="col-md-6">
                            ...
                            <div class="panel-body">
                                <form role="form" id="payment-form">
                                    ...
                                    <div class="btn-group btn-group-justified" role="group" aria-label="">
                                        ...
                                        <div class="btn-group btn-group-lg" role="group" aria-label="">
                                            <button class="btn btn-primary btn-lg btn-success next" type="submit">Cetak</button>
                                        </div>
                                    </div>
