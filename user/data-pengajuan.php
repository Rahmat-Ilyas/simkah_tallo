                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <?php if (isset($tolak)) { ?>
                                                                    <button class="btn btn-sm btn-info" data-toggle="modal" data-target="#modalKeterangan"><i class="fa fa-info-circle"></i> Keterangan</button>
                                                                    <?php } else {
                                                                    if (isset($disabled)) { ?>
                                                                        <button type="button" class="btn btn-sm btn-success" title="Pengajuan Anda masih ditinjau" disabled><i class="fa fa-download"></i> Download</button>
                                                                    <?php } else { ?>
                                                                        <button class="btn btn-sm btn-success print"><i class="fa fa-download"></i> Download</button>
                                                                <?php }
                                                                } ?>
                                                            </td>
                                                        </tr>
...
<div id="modalKeterangan" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modalKeteranganTitle" aria-hidden="true">
